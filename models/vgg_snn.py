...
class VGG16(nn.Module):
    ...
    def features(self):
        ...
        beta1 = torch.rand(64)
        self.lif1 = snn.Leaky(beta=beta1, learn_beta=True, spike_grad=self.spike_grad)
        self.conv2 = nn.Conv2d(64, 64, kernel_size=3, padding=1)
        beta2 = torch.rand(64)
        self.lif2 = snn.Leaky(beta=beta2, learn_beta=True, spike_grad=self.spike_grad)
        self.mp1 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.conv3 = nn.Conv2d(64, 128, kernel_size=3, padding=1)
        beta3 = torch.rand(32)
        self.lif3 =snn.Leaky(beta=beta3, learn_beta=True, spike_grad=self.spike_grad)
        self.conv4 = nn.Conv2d(128, 128, kernel_size=3, padding=1)
        beta4 = torch.rand(32)
        self.lif4 = snn.Leaky(beta=beta4, learn_beta=True, spike_grad=self.spike_grad)
        self.mp2 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.conv5 = nn.Conv2d(128, 256, kernel_size=3, padding=1)
        beta5 = torch.rand(16)
        self.lif5 = snn.Leaky(beta=beta5, learn_beta=True, spike_grad=self.spike_grad)
        self.conv6 = nn.Conv2d(256, 256, kernel_size=3, padding=1)
        beta6 = torch.rand(16)
        self.lif6 = snn.Leaky(beta=beta6, learn_beta=True, spike_grad=self.spike_grad)
        self.conv7 = nn.Conv2d(256, 256, kernel_size=3, padding=1)
        beta7 = torch.rand(16)
        self.lif7 = snn.Leaky(beta=beta7, learn_beta=True, spike_grad=self.spike_grad)
        self.mp3 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.conv8 = nn.Conv2d(256, 512, kernel_size=3, padding=1)
        beta8 = torch.rand(8)
        self.lif8 = snn.Leaky(beta=beta8, learn_beta=True, spike_grad=self.spike_grad)
        self.conv9 = nn.Conv2d(512, 512, kernel_size=3, padding=1)
        beta9 = torch.rand(8)
        self.lif9 = snn.Leaky(beta=beta9, learn_beta=True, spike_grad=self.spike_grad)
        self.conv10 = nn.Conv2d(512, 512, kernel_size=3, padding=1)
        beta10 = torch.rand(8)
        self.lif10 = snn.Leaky(beta=beta10, learn_beta=True, spike_grad=self.spike_grad)
        self.mp4 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.conv11 = nn.Conv2d(512, 512, kernel_size=3, padding=1)
        beta11 = torch.rand(4)
        self.lif11 = snn.Leaky(beta=beta11, learn_beta=True, spike_grad=self.spike_grad)
        self.conv12 = nn.Conv2d(512, 512, kernel_size=3, padding=1)
        beta12 = torch.rand(4)
        self.lif12 = snn.Leaky(beta=beta12, learn_beta=True, spike_grad=self.spike_grad)
        self.conv13 = nn.Conv2d(512, 512, kernel_size=3, padding=1)
        beta13 = torch.rand(4)
        self.lif13 = snn.Leaky(beta=beta13, learn_beta=True, spike_grad=self.spike_grad)
        self.mp5 = nn.MaxPool2d(kernel_size=2, stride=2)
        beta14 = torch.rand(2)
        self.lif14 = snn.Leaky(beta=beta14, learn_beta=True, spike_grad=self.spike_grad)
    ...
    def classifier(self):
        ...
        self.lif15 = snn.Leaky(beta=beta15, learn_beta=True, spike_grad=self.spike_grad)
        self.drp1 = nn.Dropout()
        self.lin2 = nn.Linear(256, 64)
        beta16 = torch.rand(64)
        self.lif16 = snn.Leaky(beta=beta16, learn_beta=True, spike_grad=self.spike_grad)
