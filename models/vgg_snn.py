...
class VGG16(nn.Module):
    ...
    def classifier(self):
        ...
        thr16 = torch.rand(64)
        self.lif16 = snn.Leaky(beta=beta16, threshold=thr16, learn_beta=True, learn_threshold=True, spike_grad=self.spike_grad)
        self.drp2 = nn.Dropout()
        self.lin3 = nn.Linear(64, self.num_classes)
        beta17 = torch.rand(2)
        thr17 = torch.rand(2)
        self.lif17 = snn.Leaky(beta=beta17, threshold=thr17, learn_beta=True, learn_threshold=True, spike_grad=self.spike_grad, output=True)
